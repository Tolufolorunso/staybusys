  ...
  return (
    <div className='root'>
        ...
        <Box display={'flex'} className='faqMain' style={{marginBottom:"100px"}}>
            ...
            <div style={{display:"flex",justifyContent:"center",width:"100%",paddingBottom:"7px"}} >  <Button href="#" target="_blank" className='faqButton' variant='contained'>  <TwitterIcon style={{ color: "white",fontSize:"36px", paddingRight: "7px" }} />{" "}
